...
/*var table =$('.tablaProductos').DataTable({
	...
	"columnDefs": [{
            ...
            "targets": -1,
            "data": null,
            "defaultContent": "<button class='btn-danger'>Click!</button>"


            /*"defaultContent": '<div class="btn-group"><button class="btn btn-warning"><i class="fa fa-pencil"></i></button><button class="btn btn-danger"><i class="fa fa-times"></i></button></div>'*/
/*        }]
    } )*/
