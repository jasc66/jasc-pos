 <div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Administrar Ingreso</li>
  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <div class="box-body">
       ...
       <!--  agregamos la clase tabla productos para hacerla dinamica y nos vamos a gregar el js a plantilla  -->
  ...
  ======================================-->
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <select class="form-control input-lg" name="nuevoTipoCedula">
                  ...
                  <option value="Fisica">Unidad</option>

                  <option value="Juridica">Par</option>

                  <option value="Juridica">Caja</option>

                  <option value="Juridica">Paquete</option>

                  <option value="Juridica">Redma</option>

                  <option value="Juridica">Rollo</option>

                  <option value="Juridica">Galón</option>
              ...
              <div class="input-group">
                ...
                <select class="form-control input-lg" id="nuevoProveedor" name="nuevoProveedor" required>
                  ...
                  foreach ($proveedores as $key => $value) {
                    ...
                    echo '<option value="'.$value["id"].'">'.$value["nombre_Proveedor"].'</option>';
                  }
                  ...
                  ?>
                        ...
                        <!-- ENTRADA PARA EL CÓDIGO PROVEEDOR -->
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" id="nuevoCodigo" name="nuevoCodigo" placeholder="Ingresar código Proveedor" readonly required>
