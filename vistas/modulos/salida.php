Salida <div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Administrar Salida</li>
  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <div class="box-header with-border">
        ...
        <button class="btn btn-primary" data-toggle="modal" data-target="#modalAgregarSalida">
      ...
      <div class="box-body">
       ...
       <table class="table table-bordered table-striped dt-responsive tablaSalida" width="100%">
